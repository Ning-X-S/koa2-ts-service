...
class NetWorkService {
  ...
  public async createNetwork(ctx: Koa.ParameterizedContext, next: Koa.Next): Promise<object> {
    try {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  public async getList(ctx: Koa.Context, next: Koa.Next): Promise<object> {
    try {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  public async getListChart(ctx: Koa.Context, next: Koa.Next): Promise<object> {
    try {
